 ...
 */
public class AlgoACACHorizontal2 extends ClassificationAlgorithm implements Serializable {
     ...
     */
    public AlgoACACHorizontal2(double minSup, double minConf, double minAllConf) {
        this.minSup = minSup;
        this.minConf = minConf;
        this.minAllConf = minAllConf;
    }

    public AlgoACACHorizontal2(double minSup, double minConf, double minAllConf, int numberOfThread) {
        this.minSup = minSup;
        this.minConf = minConf;
        this.minAllConf = minAllConf;
        this.number_Thread = numberOfThread;
    }
    ...
    public Classifier train(Dataset dataset) {
        AprioriForACACHorizontal2 apriori = new AprioriForACACHorizontal2();
        apriori.fragment = number_Thread;
        List<RuleACAC> rules = apriori.run(dataset, minSup, minConf, minAllConf);
        System.out.println("luồng = " + apriori.fragment);
        System.out.println("coi neee " + rules.size());
