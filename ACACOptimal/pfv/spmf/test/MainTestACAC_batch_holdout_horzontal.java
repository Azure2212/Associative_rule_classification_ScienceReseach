...
import ca.pfv.spmf.algorithms.classifiers.acac.AlgoACACHorizontal2;
 ...
 */
public class MainTestACAC_batch_holdout_horzontal {


    public static void main(String[] args) throws Exception {
        int n = 5; // máy tính chạy ko ổn định nên chạy 5 lần lấy trung bình
        int numberThread = 6;
        ...
        for (int i = 0; i < n; i++) {
            ...
            String targetClassName = "default_payment_next_month";

            // Load the dataset
            String datasetPath = fileToPath("zDefault_of_credit_card_clients");
...
//		dataset.printStringRepresentation();
            ...
            ClassificationAlgorithm algorithmACAC = new AlgoACACHorizontal2(minSup, minConf, minAllConf, numberThread);
    ...
    public static String fileToPath(String filename) throws UnsupportedEncodingException {
        URL url = MainTestACAC_batch_holdout_horzontal.class.getResource(filename);
