 ...
 *
 */
public class MainTestACAC_batch_holdout_HC {
	...
	public static void main(String[] args) throws Exception {
			...
			for(int i=0;i<reach;i++) {
				...
				System.out.println("========================== Set Dataset " + (index + 1) + "===============================");
...
//				}
				...
				if(temp>high){
					betterInitial.add(g.tap_chinh);
					betterAccuracy.add(temp);
				}
				if(temp>highestAccuracy){
					highestAccuracy=temp;
				...
				index++;
				System.out.println("============================================================================");
				System.out.println("running at index="+index+":"+" highestAccuracy="+highestAccuracy+" timeschange:"+TimesChangeHill +"\n better was found:"+betterInitial.size());


			}

			for(int i=0;i<betterInitial.size();i++){
				System.out.print("dataset1: ");
				for(int j=0;j<betterInitial.get(i).length;i++){
					System.out.print(betterInitial.get(i)[j]+", ");
				}
				System.out.println("accuracy="+betterAccuracy.get(i));
			}
