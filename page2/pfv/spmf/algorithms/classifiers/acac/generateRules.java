...
import ca.pfv.spmf.test.MainTestACAC_batch_holdout;
...
public class generateRules {
    ...
    public String[] tap_chinh_tot_nhat_ht={"stalk-surface-above-ring","ring-type","gill-color","odor","class"};

    public String[] tap_sub_tot_nhat_ht={"cap-shape","cap-surface","cap-color","bruises","gill-attachment","gill-spacing","stalk-shape","stalk-root","veil-type","veil-color","ring-number","population","habitat"
    };
...
//
//        for(int i1=0;i1<this.tap_chinh.length;i1++){
//            System.out.print("'"+this.tap_chinh[i1]+"', ");
//        }
//
//        System.out.println();
